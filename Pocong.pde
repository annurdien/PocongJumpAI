class Pocong {
  ...
  Pocong(ArrayList<Pad> padPositions) {
    replay = true;
    lifetime = 1000;
    brain = new NeuralNet(5,hidden_nodes,3,hidden_layers);
    pads = new ArrayList<Pad>();
  ...
  Pocong clone() {
     Pocong clone = new Pocong();
     clone.brain = brain.clone();
     return clone;
  }
  
  Pocong cloneReplay() {
     Pocong clone = new Pocong(padPos);
     clone.brain = brain.clone();
     return clone;
  }
  
  Pocong breed(Pocong parent) {
     Pocong child = new Pocong();
